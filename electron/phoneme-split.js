...
export function splitLeadingPhonemes(phonemes, budget) {
    if (budget <= 0 || phonemes.length <= budget)
        return null;
    ...
    if (head.length === 0 || rest.length === 0)
        return null;
    return [head, rest];
}
//# sourceMappingURL=phoneme-split.js.map